...
import eg.bazinga.scheduler.domin.*;
...
import eg.bazinga.scheduler.security.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        if (systemUserServiceImpl.existsByUsername(signUpRequest.getUsername())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponse("Error: Username is already taken!"));
        }

        if (systemUserServiceImpl.existsByEmail(signUpRequest.getEmail())) {
            return ResponseEntity
                    .badRequest()
        ...
        SystemUser user =
                SystemUser
                        ...
                        .emailAddress(signUpRequest.getEmail()).build();
